    ...
    <section id="about" className="section-padding bg-cream">
      ...
      >
        <motion.div variants={stagger} className="max-w-2xl mx-auto text-center mb-12 md:mb-16">
          ...
          <motion.p variants={fadeInUp} className="text-[0.88rem] text-mid-gray leading-[1.8]">
            The Sikh Ivy League Conference is a half-day event designed to connect, inspire, and
            build community. You will hear from accomplished professionals across finance,
            technology, medicine, and venture capital. You will meet Sikh peers from campuses you
            may have never visited. And you will leave with a network that extends far beyond your
            own university.
          </motion.p>
        </motion.div>

        <motion.div variants={stagger} className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-3xl mx-auto">
          {[
