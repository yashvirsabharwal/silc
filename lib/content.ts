...
export const speakers: Speaker[] = [
  {
    ...
    title: 'Director, Consumer Products & Retail',
  ...
  },
  {
    ...
    bio: 'Vice President at Insight Partners investing across SaaS, AI/ML, developer tools, and data infrastructure. Led the firm\'s Series A investment in Promptfoo, an AI security platform. Dartmouth College B.A. in Government; Jack Kent Cooke Scholar, NYT Scholar, and Coca-Cola Scholar.',
    initials: 'SS',
